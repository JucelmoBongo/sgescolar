 ...
 session_cache_expire(30);
    ...
    try {      
      if (isset($_POST["email"])) {
          $email = $_POST["email"];
        $senha = $_POST["senha"];
        $res = $conexao->query("SELECT * FROM  administrador WHERE email = '$email' AND senha = '$senha' ");
        if($res->rowCount()){

          while ($d = $res->fetchObject()) {
              $_SESSION['id_administrador'] = $d->id_administrador;
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Entrar como Administrador</h5>
                  ...
                  <form class="row g-3 needs-validation" method="POST" >
                    ...
                    <a href="index.php">Entrar como Motorista</a>
