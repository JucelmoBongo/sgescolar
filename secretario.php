<?php
 ...
 try {      
   if (isset($_POST["email"])) {
     ...
     $res = $conexao->query("SELECT * FROM  secretario WHERE email = '$email' AND senha = '$senha' ");
     if($res->rowCount()){
             // =================================
      // laço de repetição enqunto d for = a res, me tras todos os objectos d
       while ($d = $res->fetchObject()) {
           ...
           $_SESSION['nome_secretario'] = $d->nome;
           $_SESSION['telefone'] = $d->telefone;
           $_SESSION['funcao'] = $d->funcao;
           $_SESSION['email'] = $d->email;
           $_SESSION['genero'] = $d->genero;          
 
           header("location:painel/secretario/");
       } 
     }else { ?>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Entra como Secretario</h5>
                    <p class="text-center small">Entre com o seu nome e sua senha</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" method="POST">
                    ...
                    <a href="adm.php">Entrar como Adiministrador</a>
                    <a href="secretario.php">Entrar como Estudante</a>
                    <a href="professor.php">Entrar como Professor</a>
                  </form>
